...
\begin{itemize}
        \item The AWS CA Certificate  \textbf{5cloud/certs/aws-root-ca-.pem}
        \item The Device Private Key  \textbf{5cloud/certs/private.pem.key}
        \item The Device Certificate  \textbf{5cloud/certs/certificate.pem.crt}
\end{itemize}
