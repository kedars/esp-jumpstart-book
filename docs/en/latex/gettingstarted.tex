...
\begin{tcolorbox}
    \textbf{For ESP8266:}\linebreak
    ESP8266\_RTOS\_SDK is Espressif's IoT Development Framework for ESP8266. This is common reference manual for ESP32 and ESP8266. The instructions exclusively applicable to ESP8266 are under the "For ESP8266" section. All references to IDF, ESP-IDF are be mapped to ESP8266\_RTOS\_SDK in the context of ESP8266.
\end{tcolorbox}
